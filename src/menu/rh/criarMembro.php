...
<div class="rh-container">
    ...
    <div class="form-wrapper">
        <h1 class="form-title">Cadastrar Novo Membro</h1>
        ...
        <form action="./controller/criarMembro.php" method="post" enctype="multipart/form-data">
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="membro_cpf" name="membro_cpf" required maxlength="18">
                </div>             
                
                <div class="form-group">
                    <label for="membro_rg">RG *</label>
                    <input type="text" id="membro_rg" name="membro_rg" required>
                </div>

                <div class="form-group">
                    <label for="membro_email">E-mail *</label>
                    <input type="email" id="membro_email" name="membro_email" required>
                </div>
            
                <div class="form-group">
                    <label for="membro_data_nascimento">Data Nascimento *</label>
                    <input type="date" id="membro_data_nascimento" name="membro_data_nascimento" required>
                </div>

                <div class="form-group">
                    <label for="membro_habilidade">Habilidade *</label>
                    <textarea  id="membro_habilidade" name="membro_habilidade" required></textarea>
                </div>
            
                <div class="form-group">
                    <label for="membro_instagram">Instagram *</label>
                    <input  type="text" id="membro_instagram" name="membro_instagram" required></textarea>
                </div>

                <div class="form-group">
                    <label for="membro_github">GitHuB *</label>
                    <input  type="text" id="membro_github" name="membro_github" required></textarea>
                </div>

                <div class="form-group">
                    <label for="membro_whatsapp">Whatsappp *</label>
                    <input  type="number" id="membro_whatsapp" name="membro_whatsapp" required></textarea>
                </div>

                <div class="form-group">
                    <label for="membro_linkedin">Linkedin *</label>
                    <input  type="text" id="membro_linkedin" name="membro_linkedin" required></textarea>
                </div>

                <div class="form-group">
                    <label for="membro_admissao">Data de Admissão</label>
                    <input type="date" id="membro_admissao" name="membro_admissao">
                </div>

                <div class="form-group">
                    <label for="membro_ra">RA (Registro Acadêmico) *</label>
                    <input type="number" id="membro_ra" name="membro_ra" required>
                </div>

                <div class="form-group">
                    <label for="membro_periodo">Período</label>
                    <input type="number" id="membro_periodo" name="membro_periodo" min="1" max="10">
                </div>

                <div class="form-group">
                    <label for="membro_cargo">Cargo</label>
                    <input type="text" id="membro_cargo" name="membro_cargo">
                </div>

                <div class="form-group">
                    <label for="membro_area">Área</label>
                    <input type="text" id="membro_area" name="membro_area">
                </div>

                <div class="form-group">
                    <label for="membro_coeficiente">Coeficiente</label>
                    <input type="number" id="membro_coeficiente" name="membro_coeficiente" step="0.01" min="0" max="10">
                </div>

                <div class="form-group">
                    <label for="membro_celular">Celular</label>
                    <input type="number" id="membro_celular" name="membro_celular">
                </div>

                <div class="form-group full-width">
                    <label for="membro_endereco">Endereço</label>
                    <textarea id="membro_endereco" name="membro_endereco"></textarea>
                </div>
