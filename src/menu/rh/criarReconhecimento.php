...
<div class="rh-container">
    ...
    <div class="form-wrapper">
        ...
        <form action="./controller/criarReconhecimento.php" method="post" enctype="multipart/form-data">
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <textarea id="feito" name="feito" required></textarea>
                </div>

                <div class="form-group">
                    <label for="reconhecimento">Reconhecimento*</label>
                    <textarea id="reconhecimento" name="reconhecimento" required></textarea>
                </div>
            
                <div class="form-group">
                    <label for="data_reconhecimento">Data *</label>
                    <input type="date" id="data_reconhecimento" name="data_reconhecimento" required>
                </div>
