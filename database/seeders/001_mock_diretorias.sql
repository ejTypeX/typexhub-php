...
('Tecnologia',      'Desenvolvimento de sistemas, infraestrutura de TI e suporte a usuários.',               '#8A2BE2',         1),
('Jurídico',        'Assessoria em questões legais, contratos e conformidade regulatória.',                     '#DC143C',         0);
